...
### ⛏️ Майнінг
- Автоматичний заробіток +0.0010 BBC/сек
- Збереження прогресу при перезапуску
- Синхронізація між пристроями

### 💳 Трансфери
- Переводи коштів іншим гравцям
- Комісія 5% (мін. 0.0001 BB) на BB-транзакції
...
- **Слоти** з таблицею виплат
- **Техаський холдем / draw poker**: 5 карт, до 3 замін і виплати за комбінації
...
### Холдем
1. Перейдіть на "🎰 Casino" → "🃏 Холдем"
2. Введіть ставку та натисніть "РОЗДАТИ"
3. Оберіть карти, які хочете залишити
4. До 3 разів замінюйте інші карти або завершіть руку раніше
